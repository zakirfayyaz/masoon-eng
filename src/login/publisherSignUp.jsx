...
class PublisherSignUp extends Component {
  state = { visible: 0, data: { Role: "Publisher" }, creditCardShow: false };
  componentDidMount() {
    ...
    try {
      ...
      if (status === 200) {
        if (message === "User registered successfully") {
          toast.success("☑️ Account successfully", {
            position: "top-center",
            autoClose: 3000,
              ...
              <div className="form-form-wrap">
                <div className="form-container">
                  <div className="form-content">
                    ...
                    <h5 className="">Registering as Publisher</h5>
